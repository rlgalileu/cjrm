...
const my3FavoriteTVShows = ['Jujutsu Kaisen', 'Shingeki no Kyojin', 'Zettai Karen Children']
...
const isTypeSentenceGreaterThan = String(typeSentence.length > numberToCheck)
const firstIndex = isTypeSentenceGreaterThan[0]
const result = isTypeSentenceGreaterThan.replace(firstIndex, firstIndex.toUpperCase())

// console.log(`A string que a "typeSentence" armazena tem mais de ${numberToCheck} caracteres? ${result}.`)
